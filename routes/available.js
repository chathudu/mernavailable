...
const Item = require("../models/Available");
...
router.route("/add").post(upload.single("image"), async (req, res) => {
  try {
    ...
    const surename = req.body.lastName;
    const address = req.body.lastName;
    const confirmpaticipation = req.body.lastName;
    const dateparticipation = req.body.lastName;
    const accommodation = req.body.lastName;
    const accommodationdate = req.body.lastName;
    const attendweight = req.body.lastName;
    const role = req.body.lastName;
    const letter = req.body.lastName;
    const letteryes = req.body.lastName;
    const food = req.body.lastName;
